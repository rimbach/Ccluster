...
/* memory managment */
static __inline__ void compRat_poly_init( compRat_poly_t x ){
    realRat_poly_init( compRat_poly_realref(x) );
    realRat_poly_init( compRat_poly_imagref(x) );
}

static __inline__ void compRat_poly_init2( compRat_poly_t x, slong size ){
    realRat_poly_init2( compRat_poly_realref(x), size );
    realRat_poly_init2( compRat_poly_imagref(x), size );
}

static __inline__ void compRat_poly_clear( compRat_poly_t x ){
    realRat_poly_clear( compRat_poly_realref(x) );
    realRat_poly_clear( compRat_poly_imagref(x) );
}

/* members access */
static __inline__ realRat_poly_ptr compRat_poly_real_ptr(compRat_poly_t z) { return compRat_poly_realref(z); }
static __inline__ realRat_poly_ptr compRat_poly_imag_ptr(compRat_poly_t z) { return compRat_poly_imagref(z); }

static __inline__ void compRat_poly_get_real(realRat_poly_t re, const compRat_poly_t z) {
    realRat_poly_set(re, compRat_poly_realref(z));
}

static __inline__ void compRat_poly_get_imag(realRat_poly_t im, const compRat_poly_t z) {
    realRat_poly_set(im, compRat_poly_imagref(z));
}

/* setting */
static __inline__ void compRat_poly_set(compRat_poly_t z, const compRat_poly_t x) {
...
static __inline__ void compRat_poly_zero(compRat_poly_t z) {
    realRat_poly_zero(compRat_poly_realref(z));
    realRat_poly_zero(compRat_poly_imagref(z));
}

static __inline__ void compRat_poly_set_realRat_poly(compRat_poly_t z, const realRat_poly_t x) {
    realRat_poly_set(compRat_poly_realref(z), x);
    realRat_poly_zero(compRat_poly_imagref(z));
}

static __inline__ void compRat_poly_set2_realRat_poly
...
static __inline__ int compRat_poly_print(const compRat_poly_t x) {
    return compRat_poly_fprint(stdout, x);
}

int compRat_poly_fprint_pretty(FILE * file, const compRat_poly_t poly, const char * var);

static __inline__ int compRat_poly_print_pretty(const compRat_poly_t poly, const char * var) {
