...
#include <stdlib.h>
#include <stdio.h>
// #include "fmpq.h" /*for definition of FILE*/
...
static __inline__ gen_list_iterator gen_list_begin(const gen_list_t l){
    return l->_begin;
}

static __inline__ gen_list_iterator gen_list_next(gen_list_iterator it){
    return it->_next;
}

static __inline__ gen_list_iterator gen_list_end(){
    return NULL;
}

static __inline__ void * gen_list_elmt(gen_list_iterator it){
    return it->_elmt;
}
