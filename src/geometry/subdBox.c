...
// void subdBox_risolate_bisect_withRootRadii( compBox_list_t res, const compBox_t b) {
//     
//     realRat_t shift, width;
//     realRat_init(shift);
//     realRat_init(width);
...
//     
//     /* root radii */
//     compBox_init_annuli(bE);
//     compBox_actualize_anulii_risolate( bE, compBox_annuliref(b) );
//     compBox_init_annuli(bW);
//     compBox_actualize_anulii_risolate( bW, compBox_annuliref(b) );
//     
// //     printf("b : "); compBox_print(b ); printf("\n");
// //     printf("bE: "); compBox_print(bE); printf("\n");
// //     printf("bW: "); compBox_print(bW); printf("\n");
...
// void subdBox_risolate_bisect_with_compDsk_rootRadii( compBox_list_t res, const compBox_t b, const compDsk_t d, const realRat_t nwidth){
//     
//     realRat_t quo;
//     realRat_t half, halfwidth, halfnwidth, temp;
//     realRat_t leftCorner, rightCorner;
...
//             
//             /* root radii */
//             compBox_init_annuli(bnew);
//             compBox_actualize_anulii_risolate( bnew, compBox_annuliref(b) );
//             
//             compBox_list_push(res, bnew);
//         }
//         else {
