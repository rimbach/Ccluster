...
void chronos_init( chronos_t times ){
    ...
    times->_clicks_CertPel_cumul = 0.0;
    times->_clicks_CertPEv_cumul = 0.0;
    times->_clicks_CertPIn_cumul = 0.0;
    times->_clicks_CertPGr_cumul = 0.0;
