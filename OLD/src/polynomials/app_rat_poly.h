...
static __inline__ void compApp_poly_set_realRat_poly(compApp_poly_t poly, const realRat_poly_t re, slong prec) {
    compApp_poly_set_fmpq_poly(poly, re, prec);
}
/* converting realRat_poly to compApp_poly ... the same not inlined for julia  */
void compApp_poly_set_realRat_poly_forJulia(compApp_poly_t poly, const realRat_poly_t re, slong prec);

/* converting compRat_poly to compApp_poly  */
static __inline__ void compApp_poly_set_compRat_poly(compApp_poly_t poly, const compRat_poly_t pRat, slong prec) {
...
void compApp_poly_scale_realRat_in_place_forJulia( compApp_poly_t poly, const realRat_t r, slong prec );
