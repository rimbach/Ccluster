...
for DEG in $DEGREES; do
    ...
    if [ ! -e $FILENAME_CCLUSTER_L_OUT ]; then
        ...
        ./benchBernoulli $DEG $BLOCAL $EPSILONCCL $VFLAG "3" > $FILENAME_CCLUSTER_L_OUT
    fi
    if [ ! -e $FILENAME_CCLUSTER_G_OUT ]; then
        ...
        ./benchBernoulli $DEG $BGLOBAL $EPSILONCCL $VFLAG "3" > $FILENAME_CCLUSTER_G_OUT
    fi
