...
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v41.out" ]; then
    ...
    ./benchBernoulli $DEGREE $BOX $EPS1 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v41.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v42.out" ]; then
    ...
    ./benchBernoulli $DEGREE $BOX $EPS2 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v42.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v43.out" ]; then
    ...
    ./benchBernoulli $DEGREE $BOX $EPS3 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v43.out"
fi
...
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v41.out" ]; then
    ...
    ./benchMignotte $DEGREE $BITSIZE $BOX $EPS1 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v41.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v42.out" ]; then
    ...
    ./benchMignotte $DEGREE $BITSIZE $BOX $EPS2 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v42.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v43.out" ]; then
    ...
    ./benchMignotte $DEGREE $BITSIZE $BOX $EPS3 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v43.out"
fi
...
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v41.out" ]; then
    echo  "Clustering roots for $POL_NAME, degree $DEGREE version V4 eps=2^$EPS1 output in "$REP"/"$POL_NAME"_"$DEGREE"_v41.out" > /dev/stderr
    ./benchWilkinson $DEGREE $BOX $EPS1 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v41.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v42.out" ]; then
    echo  "Clustering roots for $POL_NAME, degree $DEGREE version V4 eps=2^$EPS2 output in "$REP"/"$POL_NAME"_"$DEGREE"_v42.out" > /dev/stderr
    ./benchWilkinson $DEGREE $BOX $EPS2 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v42.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v43.out" ]; then
    echo  "Clustering roots for $POL_NAME, degree $DEGREE version V4 eps=2^$EPS3 output in "$REP"/"$POL_NAME"_"$DEGREE"_v43.out" > /dev/stderr
    ./benchWilkinson $DEGREE $BOX $EPS3 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v43.out"
fi
...
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v41.out" ]; then
    echo  "Clustering roots for $POL_NAME, degree $DEGREE version V4 eps=2^$EPS1 output in "$REP"/"$POL_NAME"_"$DEGREE"_v41.out" > /dev/stderr
    ./benchSpiral $DEGREE $BOX $EPS1 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v41.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v42.out" ]; then
    echo  "Clustering roots for $POL_NAME, degree $DEGREE version V4 eps=2^$EPS2 output in "$REP"/"$POL_NAME"_"$DEGREE"_v42.out" > /dev/stderr
    ./benchSpiral $DEGREE $BOX $EPS2 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v42.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v43.out" ]; then
    echo  "Clustering roots for $POL_NAME, degree $DEGREE version V4 eps=2^$EPS3 output in "$REP"/"$POL_NAME"_"$DEGREE"_v43.out" > /dev/stderr
    ./benchSpiral $DEGREE $BOX $EPS3 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v43.out"
fi
...
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v41.out" ]; then
    ...
    ./benchMignotteGen $DEGREE $BITSIZE $POW $BOX $EPS1 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v41.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v42.out" ]; then
    ...
    ./benchMignotteGen $DEGREE $BITSIZE $POW $BOX $EPS2 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v42.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v43.out" ]; then
    ...
    ./benchMignotteGen $DEGREE $BITSIZE $POW $BOX $EPS3 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v43.out"
fi
...
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v41.out" ]; then
    echo  "Clustering roots for $POL_NAME, $NBSOLS sols version V4 eps=2^$EPS1 output in "$REP"/"$POL_NAME"_"$DEGREE"_v41.out" > /dev/stderr
    ./benchCluster $ITTS $BOX $EPS1 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v41.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v42.out" ]; then
    echo  "Clustering roots for $POL_NAME, $NBSOLS sols version V4 eps=2^$EPS2 output in "$REP"/"$POL_NAME"_"$DEGREE"_v42.out" > /dev/stderr
    ./benchCluster $ITTS $BOX $EPS2 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v42.out"
fi
if [ ! -e $REP"/"$POL_NAME"_"$DEGREE"_v43.out" ]; then
    echo  "Clustering roots for $POL_NAME, $NBSOLS sols version V4 eps=2^$EPS3 output in "$REP"/"$POL_NAME"_"$DEGREE"_v43.out" > /dev/stderr
    ./benchCluster $ITTS $BOX $EPS3 $V4PFLAG "3" > $REP"/"$POL_NAME"_"$DEGREE"_v43.out"
fi
